...
url_custom = [{icon_pack = "far", icon="file-pdf", name="Proposal", url = "https://tungpv.com/project/ted-recommender/TED-Recommender-Proposal.pdf"}, {icon_pack = "far", {icon_pack = "fab", icon="chrome", name="TED-Recommender Application", url = "http://ted-recommender.com"}]
